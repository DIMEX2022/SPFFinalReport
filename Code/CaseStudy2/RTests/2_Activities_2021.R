...
###    * I removed the loop, which previously repeated the activity 
###      sampling through the different MSOAs 
###    * Change the pop_strata in sample_population() function from area_id 
###      to sex
###    * Change nsample to equal 5 so that I get 5 of each sex, and a total 
###      test sample of 10

# Sampling activities 
activities_complete <- sample_population(pop_dat, 
...
# Saving datasets 
save(activities_complete, file = 'Code/CaseStudy2/RTests/test_activities.RData')
